    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="theme-setting-wrapper">
            ...
            <div id="theme-settings" class="settings-panel">
                <i class="settings-close fa fa-arrow-left"></i>
        ...
        <div class="main-panel">
            ...
            <footer class="footer">
                <div class="d-sm-flex justify-content-center justify-content-sm-between">
                    <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2021 <a href="" target="_blank"></a>. All rights reserved.</span>
                    <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> <i class="fa fa-heart text-danger ms-1"></i></span>
                </div>
            </footer>
            <!-- partial -->
        </div>
